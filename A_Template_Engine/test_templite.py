...
class TempliteTest(TestCase):
    ...
    def test_pipes(self):
        ...
        self.try_render("Hello, {{name|upper|second}}!", data, "Hello, O!")
    ...
    def test_reusability(self):
        ...
        self.assertEqual(template.render({'name': 'Bob'}), "This is BOB!")
        self.assertEqual(template.render({'name': 'Mist'}), "This is MIST!")
    ...
    def test_member_function(self):
        # Variables' member function can be used, as long as they are nullary.
    ...
    def test_loops(self):
        ...
        # Loops iterables can be filtered.
        def rev(l):
